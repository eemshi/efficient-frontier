...
return [(function (){var pred__21896 = cljs.core.instance_QMARK_;
var expr__21897 = reactive_val;
if(cljs.core.truth_(pred__21896.call(null,reagent.ratom.RAtom,expr__21897))){
return "ra";
} else {
if(cljs.core.truth_(pred__21896.call(null,reagent.ratom.RCursor,expr__21897))){
return "rc";
} else {
if(cljs.core.truth_(pred__21896.call(null,reagent.ratom.Reaction,expr__21897))){
return "rx";
} else {
if(cljs.core.truth_(pred__21896.call(null,reagent.ratom.Track,expr__21897))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1643864552034
