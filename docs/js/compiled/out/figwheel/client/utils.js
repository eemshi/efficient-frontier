...
return (new CustomEvent(event_name,(function (){var obj24874 = ({"detail":data__$1});
return obj24874;
})()));
} else {
...
var f = (function (){var pred__24881 = cljs.core._EQ_;
var expr__24882 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24881.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24882))){
return (function (p1__24875_SHARP_){
return console.warn(p1__24875_SHARP_);
});
} else {
if(cljs.core.truth_(pred__24881.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24882))){
return (function (p1__24876_SHARP_){
return console.debug(p1__24876_SHARP_);
});
} else {
if(cljs.core.truth_(pred__24881.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24882))){
return (function (p1__24877_SHARP_){
return console.error(p1__24877_SHARP_);
});
} else {
return (function (p1__24878_SHARP_){
return console.log(p1__24878_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24885){
...
var eval_fn = cljs.core.get.call(null,map__24886__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__24888_SHARP_){
return new_def.callback(p1__24888_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__24889){
var vec__24890 = p__24889;
var ky = cljs.core.nth.call(null,vec__24890,(0),null);
var v = cljs.core.nth.call(null,vec__24890,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1643864555780
