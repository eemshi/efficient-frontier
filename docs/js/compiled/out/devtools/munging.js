...
var o25568 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25568["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25569 = temp__5733__auto____$1;
return (o25569["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24926__auto__ = f;
return (o__24926__auto__["toString"]).call(o__24926__auto__);
} else {
return "";
}
...
try{var o__24926__auto___25572 = t;
(o__24926__auto___25572["cljs$lang$ctorPrWriter"]).call(o__24926__auto___25572,t,writer);
}catch (e25571){var __25573 = e25571;
}
...
var char_code = (function (){var o__24926__auto__ = (new String(char$));
return (o__24926__auto__["charCodeAt"]).call(o__24926__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24926__auto__ = String;
return (o__24926__auto__["fromCharCode"]).call(o__24926__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25574 = num_code;
switch (G__25574) {
case (1):
return (185);
...
var o__24926__auto__ = String;
return (o__24926__auto__["fromCharCode"]).call(o__24926__auto__,superscript_code);
});
/**
...
}catch (e25576){var _e__24933__auto__ = e25576;
return false;
}})())){
...
var vec__25577 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25577,(0),null);
...
var len__4736__auto___25586 = arguments.length;
var i__4737__auto___25587 = (0);
while(true){
if((i__4737__auto___25587 < len__4736__auto___25586)){
args__4742__auto__.push((arguments[i__4737__auto___25587]));

var G__25588 = (i__4737__auto___25587 + (1));
i__4737__auto___25587 = G__25588;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25582){
var vec__25583 = p__25582;
var ns_detector = cljs.core.nth.call(null,vec__25583,(0),null);
...
var G__25589 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25590 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25589;
remaining_tokens = G__25590;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25580){
var G__25581 = cljs.core.first.call(null,seq25580);
var seq25580__$1 = cljs.core.next.call(null,seq25580);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25581,seq25580__$1);
}));
...
var vec__25594 = cljs.core.split_with.call(null,(function (p1__25593_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25593_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25594,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25594,(1),null);
...
var vec__25600 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25600,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25600,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25603 = cljs.core.rest.call(null,remaining_tokens);
var G__25604 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25603;
name_tokens = G__25604;
continue;
} else {
...
var vec__25607 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25607,(0),null);
var arity = cljs.core.nth.call(null,vec__25607,(1),null);
var vec__25610 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25610,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25610,(1),null);
var vec__25613 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25613,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25613,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25613,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25613,(3),null);
...
var vec__25619 = result;
var munged_ns = cljs.core.nth.call(null,vec__25619,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25619,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25619,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25619,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25619,(4),null);
var arity = cljs.core.nth.call(null,vec__25619,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__25623 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__25623,(0),null);
var args = cljs.core.nth.call(null,vec__25623,(1),null);
var vec__25626 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25626,(0),null);
var name = cljs.core.nth.call(null,vec__25626,(1),null);
...
var G__25629 = (arity + (1));
var G__25630 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25631){
var vec__25632 = p__25631;
var arity = cljs.core.nth.call(null,vec__25632,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25632,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25635_SHARP_){
return cljs.core.get.call(null,arities,p1__25635_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25636_SHARP_){
return cljs.core.drop.call(null,(2),p1__25636_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___25643 = arguments.length;
var i__4737__auto___25644 = (0);
while(true){
if((i__4737__auto___25644 < len__4736__auto___25643)){
args__4742__auto__.push((arguments[i__4737__auto___25644]));

var G__25645 = (i__4737__auto___25644 + (1));
i__4737__auto___25644 = G__25645;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25639){
var vec__25640 = p__25639;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25640,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25637){
var G__25638 = cljs.core.first.call(null,seq25637);
var seq25637__$1 = cljs.core.next.call(null,seq25637);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25638,seq25637__$1);
}));
...
var G__25646 = arg;
var G__25646__$1 = (((G__25646 instanceof cljs.core.Keyword))?G__25646.fqn:null);
switch (G__25646__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25648__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25648__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25648__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25648__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25649 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25649,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25649,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25649,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25649,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25649,(4),null);
var arity = cljs.core.nth.call(null,vec__25649,(5),null);
...
var o__24926__auto__ = f;
return (o__24926__auto__["getBasis"]).call(o__24926__auto__);
});
/**
...
}catch (e25653){var _e__24933__auto__ = e25653;
...
var G__25654 = (obj[cljs.core.first.call(null,path)]);
var G__25655 = cljs.core.rest.call(null,path);
obj = G__25654;
path = G__25655;
continue;
} else {
...
var _STAR_ = (function (accum,p__25656){
var vec__25657 = p__25656;
var bit = cljs.core.nth.call(null,vec__25657,(0),null);
var protocol = cljs.core.nth.call(null,vec__25657,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25660){
var vec__25661 = p__25660;
var ns = cljs.core.nth.call(null,vec__25661,(0),null);
var name = cljs.core.nth.call(null,vec__25661,(1),null);
var selector = cljs.core.nth.call(null,vec__25661,(2),null);
...
var post_process = (function (p__25665){
var vec__25666 = p__25665;
var munged_name = cljs.core.nth.call(null,vec__25666,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25666,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25664_SHARP_){
return (obj[cljs.core.first.call(null,p1__25664_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1643864556288
