...
var G__21748 = o;
goog.object.set(G__21748,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21752 = o;
goog.object.set(G__21752,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__21753__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__21754__i < G__21754__a.length) {G__21754__a[G__21754__i] = arguments[G__21754__i + 0]; ++G__21754__i;}
  args = new cljs.core.IndexedSeq(G__21754__a,0,null);
} 
return G__21753__delegate.call(this,args);};
...
return G__21753__delegate(args);
});
...
var G__21756 = props;
var G__21756__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21756,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21756);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21756__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__21757 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21757,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__21757;
}
})(),id_class);
...
var G__21758 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21758) {
case (0):
...
var vec__21760 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21760,(0),null);
var id = cljs.core.nth.call(null,vec__21760,(1),null);
var className = cljs.core.nth.call(null,vec__21760,(2),null);
...
var temp__5739__auto___21763 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___21763 == null)){
} else {
var key_21764 = temp__5739__auto___21763;
(jsprops.key = key_21764);
}
...
var temp__5739__auto___21765 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___21765 == null)){
} else {
var key_21766 = temp__5739__auto___21765;
(jsprops.key = key_21766);
}
...
var temp__5739__auto___21767 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___21767 == null)){
} else {
var key_21768 = temp__5739__auto___21767;
(jsprops.key = key_21768);
}
...
var temp__5739__auto___21769 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___21769 == null)){
} else {
var key_21770 = temp__5739__auto___21769;
(jsprops.key = key_21770);
}
...
var temp__5739__auto___21771 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___21771 == null)){
} else {
var key_21772 = temp__5739__auto___21771;
(jsprops.key = key_21772);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__21773_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__21773_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21774 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__21774,(0),null);
var derefed = cljs.core.nth.call(null,vec__21774,(1),null);
...
break;
default:
var G__21779 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__21780 = compiler;
v = G__21779;
compiler = G__21780;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21784 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21784 = (function (opts,id,fn_to_element,meta21785){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21784.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21786,meta21785__$1){
var self__ = this;
var _21786__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21784(self__.opts,self__.id,self__.fn_to_element,meta21785__$1));
}));

(reagent.impl.template.t_reagent$impl$template21784.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21786){
var self__ = this;
var _21786__$1 = this;
return self__.meta21785;
}));

(reagent.impl.template.t_reagent$impl$template21784.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21784.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21784.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21784.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21784.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta21785","meta21785",-1838620918,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21784.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21784.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21784");

(reagent.impl.template.t_reagent$impl$template21784.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template21784");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21784.
 */
reagent.impl.template.__GT_t_reagent$impl$template21784 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21784(opts__$1,id__$1,fn_to_element__$1,meta21785){
return (new reagent.impl.template.t_reagent$impl$template21784(opts__$1,id__$1,fn_to_element__$1,meta21785));
});

}

return (new reagent.impl.template.t_reagent$impl$template21784(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1643864551838
